...
\Aufg \begin{enumerate}
	\item Begründe mit Aufgabe 6 (Blatt 2), dass folgende Garbensequenz exakt ist:
	$$
	...
	\item Zeige schließlich mit (ii): $\check{H}^1(\mathbb{CP}^1,\mathcal{O}^\times)\cong \mathbb{Z}$
	
	Wir verwenden für die offene Überdeckung $(U_0,U_infty)$, die \emph{Mayer-Vietoris-Sequenz}:
	\[
	...
	\]
	Diese ist eine lange exakte Kohomologiesequenz\footnote{Das ist eine sehr bekannte Tatsache, welche wir an dieser Stelle nicht zeigen werden.}, wobei die Garbe $\underline{\mathbb{Z}}$ jeweils die passende ist, z.B für $\check H^{q}(U ,\underline{\mathbb Z})$ ist dies die Garbe welche auf $U$ die konstante Garbe ist und auf dem Komplement von $U$ 0 ist.
	Mit dieser können wir $\check{H}^2(\mathbb{CP}^1,\underline{\mathbb{Z}})\cong \mathbb{Z}$ zeigen.
\end{enumerate}
