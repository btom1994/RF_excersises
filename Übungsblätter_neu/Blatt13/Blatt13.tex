...
\Aufg Folgere aus Aufgabe 37 (Blatt 11) und der vorhergehenden Aufgabe: 
\[
...
\Aufg \begin{enumerate}
	...
	$$
	0 \to \underline{2\pi i\mathbb{Z}} \to \mathcal{O} \overset{\exp}{\to} \mathcal{O}^\times \to 0
	$$
	\item Folgere nun mithilfe der induzierten langen Kohomologiesequenz: $\check{H}^1(\mathbb{CP}^1,\mathcal{O}^\times)\cong \check{H}^1(\mathbb{CP}^1,\underline{\mathbb{Z}})$
