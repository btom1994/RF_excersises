...
\medskip \centerline{13. Blatt -- Abgabe 28.01, Übung 29.01}
...
\]
eine kurze exakte Sequenz von Garben auf $X$.\footnote{Eine solche heißt exakt, wenn sie halmweise exakt ist, d.h. $\forall p\in X: 0\to\mathcal{F}_p\to\mathcal{G}_p\to\mathcal{H}_p\to 0$ ist exakt.} Zeige, dass für jedes offene $U\subset X$ die Sequenz
\[
...
\emph{Hinweis:} Variiere den Beweis zu Satz 8.3.

\medskip

\noindent\textbf{Bemerkung:} Da letzte Woche eine Vorlesung entfallen ist, hängen wir leicht hinterher. Deshalb sind die nächsten beiden Aufgaben erst mit der Vorlesung am Freitag lösbar. Man kann dann auch Aufgabe 42 mit der langen exakten Kohomologiesequenz lösen.
\medskip

\Aufg  Ziel dieser Aufgabe ist $\check{H}^1(\mathbb{CP}^1,\mathcal{O}^\times)\cong \mathbb{Z}$ (und damit auch $\mathrm{Pic}(\mathbb{CP}^1)\cong\mathbb{Z}$, vgl. Bemerkung Blatt 12) zu zeigen. Wir gehen folgendermaßen vor:
\begin{enumerate}
	...
	Außerdem gilt\footnote{Da wir nie mit $\check{H}^r$ für $r\geq2$ gearbeitet haben, sei diese Aussage auch ohne Beweis gegeben.} $\check{H}^r(U,\underline{\mathbb{Z}})=0$ für $r\geq1$ und $U\cong\mathbb{C}$.
\end{enumerate}
