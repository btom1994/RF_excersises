...
\begin{enumerate}
	...
	Außerdem gilt\footnote{Da wir nie mit $\check{H}^2$ gearbeitet haben, sei diese Aussage auch ohne Beweis gegeben.} $\check{H}^r(U,\underline{\mathbb{Z}})=0$ für $r\geq1$ und $U\cong\mathbb{C}$.
\end{enumerate}
