...
Auf dem Blatt sei \(X\) immer eine kompakte zusammenhängende Riemannsche Fläche.

\Aufg Für \(P\in X\) sei \(\mathbb{C}_P\) die Wolkenkratzergarbe wie in der Vorlesung betrachtet. Zeige, dass
\[
...
\Aufg Sei \(D\) ein Divisor auf \(X\). Zeige:
