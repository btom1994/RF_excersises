...
\begin{enumerate}
	...
	\item Für je zwei Punkte \(P,Q\in\mathbb{CP}^1\) gilt \(P\sim Q\) als Divisoren. Zeige, dass jeder Divisor vom Grad $0$ auf $\mathbb{CP}^1$ ein Hauptdivisor ist.
