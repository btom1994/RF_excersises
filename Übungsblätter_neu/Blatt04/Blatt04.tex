...
\]
\emph{Hinweis:} Es handelt sich hierbei um die \emph{Joukowski Transformation}. Der unten abgebildete SageMath-Code plottet die Bilder von Kreisen unter dieser Tranformation. Wer will, kann damit herumspielen und erklären, warum diese Transformation eine Rolle im Flugzeugbau spielen könnte.
