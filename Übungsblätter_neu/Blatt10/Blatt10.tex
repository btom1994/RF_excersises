...
\begin{enumerate}
	\item Die Abbildung
	\[
	H^{1}(X, \mathbb{Z}) \;\longrightarrow\; H^{1}(X, \mathbb{C}),
	\]
	induziert durch die Inklusion \(\mathbb{Z} \subset \mathbb{C}\), ist injektiv.
	
	\item \(H^{1}(X, \mathbb{Z})\) ist ein endlich erzeugter freier \(\mathbb{Z}\)-Modul ist.
	
	\emph{Hinweis: Zeige zuerst, dass \(H^{1}(X, \mathbb{Z})\) endlich erzeugt ist, und benutze dann (i), um zu beweisen, dass \(H^{1}(X, \mathbb{Z})\) frei ist.}
\end{enumerate}
\end{document}
