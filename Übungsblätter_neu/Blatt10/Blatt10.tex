...
\vspace*{0.2cm}\noindent{\bf
	Bemerkung:} Zu Beginn des Semesters haben wir Garben kennengelernt. Damals fiel der Begriff \emph{Garbifizierung}. Die hier gesehene Garbe $\mathcal{G}$ ist die Garbifizierung der Prägarbe $\mathcal{F}$.
\medskip
