...
\Aufg \begin{enumerate}
	\item Zeige den Residuensatz auf $\mathbb{CP}^1$ mit Hilfe des Residuensatzes aus der Funktionentheorie. 
	
	\emph{Hinweis:} Wähle einen geeigneten Integrationsweg auf $\mathbb{CP}^1=\mathbb{C}\sqcup\{\infty\}$.
	
	\item Sei $f:X\to\mathbb{CP}^1$ eine nicht-konstante, holomorphe Abbildung, $X$ kompakte Riemannsche Fläche. Wir wissen (aus der Überlagerungstheorie), dass jeder Wert $c\in\mathbb{CP}^1$ gleich oft angenommen wird (mit Vielfachheit). Wie folgt das auch aus dem Residuensatz?
\end{enumerate}
