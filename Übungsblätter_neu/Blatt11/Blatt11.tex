...
\Aufg Zeige, dass \(\mathscr{U}=(U_1,U_2)\) mit \(U_1:=\mathbb{C}\setminus\mathbb{R}_{\ge0}\) und \(U_2:=\mathbb{C}\setminus\mathbb{R}_{\le0}\) eine Leray-Überdeckung für \(\check{H}^1(\mathbb{C}\setminus\{0\},\mathcal{O})\) ist und versuche damit \(\check{H}^1(\mathbb{C}\setminus\{0\},\mathcal{O})\) zu bestimmen.
