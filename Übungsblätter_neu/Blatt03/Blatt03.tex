...
\medskip \centerline{3. Blatt -- Abgabe 05.11, Übung 06.11}
...
\begin{enumerate}
	...
	\[
	U \mapsto \{ (f_0, f_\infty) \mid \forall j\in\{0,\infty\}: f_j : U \cap U_j \to \mathbb{C} \text{ holomorph und } \forall z \in U \cap U_0 \cap U_\infty: f_0(z) = z^{m} f_\infty(z) \} 
	\]
...
\emph{Hinweis:} Das Berechnen der Nullstellen ist nicht trivial:\footnote{vgl: M. Eichler, D. Zagier, \emph{On the Zeros of the Weierstraß} $\wp$\emph{-function}, Math. Ann. 258, 399–407 (1982)} 

\medskip 

\includegraphics[scale=0.7]{Theorem_ZerosWeierstrass}
