...
\Aufg Sei \( f : X \to Y \) eine nicht konstante holomorphe Abbildung zwischen kompakten Riemannschen Flächen. Sind dann \( S \subset X \) die Verzweigungspunkte und \( S' = f(S) \), so ist 
