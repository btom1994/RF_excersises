...
\noindent\textbf{Definition:} Sei \( f : X \to Y \) eine holomorphe Abbildung kompakter Riemannscher Flächen. Der \emph{Verzweigungsindex} von \( f \) bei \( x \in X \) ist definiert als
\[
...
\Aufg Zeige mithilfe der Riemann-Hurwitz-Formel, dass für einen Torus $T$ gilt: 
$$g(T)=1.$$

\emph{Hinweis:} Benutze hierfür die beliebte Aufgabe 17 iii).
